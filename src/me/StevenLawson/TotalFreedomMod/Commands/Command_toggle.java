...
@CommandParameters(description = "Toggles " + TotalFreedomMod.MOD_NAME + " settings", usage = "/<command> [option] [value] [value]")
public class Command_toggle extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            if (!TFM_Util.isHighRank(sender) || sender.getName().equals(TotalFreedomMod.SERVER_OWNER))
            {
